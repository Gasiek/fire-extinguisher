...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Y Button Press"",
                    ""type"": ""Button"",
                    ""id"": ""7cd0d2b1-43f2-4861-b077-11336d01aa05"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""X Button Press"",
                    ""type"": ""Button"",
                    ""id"": ""89b1cfd0-3435-4c93-9457-f99854542dcb"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""3dbd28d4-9e01-41a5-b313-eb0735771327"",
                    ""path"": ""<XRController>{LeftHand}/secondaryButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""Y Button Press"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""de679dec-010d-4b57-a0e6-eeb10f49887b"",
                ...
                {
                    ""name"": """",
                    ""id"": ""511a6b0f-1d04-4747-89d2-f4bff9e6576c"",
                    ""path"": ""<XRController>{LeftHand}/primaryButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""X Button Press"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""e9c34964-d5aa-48de-9df4-e74e087dd374"",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHandInteraction_YButtonPress = m_XRILeftHandInteraction.FindAction("Y Button Press", throwIfNotFound: true);
        m_XRILeftHandInteraction_XButtonPress = m_XRILeftHandInteraction.FindAction("X Button Press", throwIfNotFound: true);
    ...
    private readonly InputAction m_XRILeftHandInteraction_YButtonPress;
    private readonly InputAction m_XRILeftHandInteraction_XButtonPress;
    public struct XRILeftHandInteractionActions
    {
        ...
        public InputAction @YButtonPress => m_Wrapper.m_XRILeftHandInteraction_YButtonPress;
        public InputAction @XButtonPress => m_Wrapper.m_XRILeftHandInteraction_XButtonPress;
        ...
        public void SetCallbacks(IXRILeftHandInteractionActions instance)
        {
            if (m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface != null)
            {
                ...
                @YButtonPress.started -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnYButtonPress;
                @YButtonPress.performed -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnYButtonPress;
                @YButtonPress.canceled -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnYButtonPress;
                @XButtonPress.started -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnXButtonPress;
                @XButtonPress.performed -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnXButtonPress;
                @XButtonPress.canceled -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnXButtonPress;
            }
            ...
            if (instance != null)
            {
                ...
                @YButtonPress.started += instance.OnYButtonPress;
                @YButtonPress.performed += instance.OnYButtonPress;
                @YButtonPress.canceled += instance.OnYButtonPress;
                @XButtonPress.started += instance.OnXButtonPress;
                @XButtonPress.performed += instance.OnXButtonPress;
                @XButtonPress.canceled += instance.OnXButtonPress;
            }
        }
    }
    ...
    public interface IXRILeftHandInteractionActions
    {
        ...
        void OnYButtonPress(InputAction.CallbackContext context);
        void OnXButtonPress(InputAction.CallbackContext context);
    }
